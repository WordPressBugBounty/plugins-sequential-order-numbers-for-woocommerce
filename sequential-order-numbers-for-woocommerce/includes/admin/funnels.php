<?php
if ( ! class_exists( 'brordernumbers_free_funnels' ) ) {
	class brordernumbers_free_funnels {
		...
		public function spring_premium_days_2026(): void {
			...
			$media      = '?utm_source=free_plugin&utm_medium=admin_notice&utm_campaign=spring_2026&utm_content=top_banner_cta&utm_term=ordernumbers';
	...
	new brordernumbers_free_funnels();
}